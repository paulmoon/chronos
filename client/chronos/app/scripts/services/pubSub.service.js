/**
 * Credit: https://github.com/georapbox/angular-PubSub
 */
...
(function () {
  ...
  PubSubService.$inject = ['$timeout'];

  function PubSubService($timeout) {
    /**
     ...
     *
     * @param topic {String || Object} Topic name or subscription referenece.
